# Graph Report - pak-pon  (2026-07-23)

## Corpus Check
- 225 files · ~248,288 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1025 nodes · 1958 edges · 92 communities (53 shown, 39 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 34 edges (avg confidence: 0.81)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `b1f513b6`
...
Cohesion: 0.06
Nodes (48): savePrinterSettings(), SettingsSchema, SettingsState, PrinterSettingsForm(), isKitchenItem(), MenuCategory, PrinterTarget, ReprintCard() (+40 more)

### Community 1 - "Reports & Home Pages"
Cohesion: 0.05
Nodes (76): computeDisplayState(), DisplayState, GET(), DELETE(), isUuid(), PATCH(), AgentPatchInput, AgentPatchSchema (+68 more)
...
Cohesion: 0.12
Nodes (24): DateFilter(), AlertDialogMedia(), AlertDialogOverlay(), Card(), CardAction(), CardContent(), CardDescription(), CardFooter() (+16 more)
...
Cohesion: 0.19
Nodes (12): MenuOption, NotaReviewForm(), PosClient(), CATEGORY_LABEL, CATEGORY_ORDER, PosMenuPicker(), formatDateWIB(), formatTimeWIB() (+4 more)
...
Cohesion: 0.15
Nodes (24): Agent, badgeClassesFor(), badgeLabelFor(), DisplayState, formatTxLabel(), Job, PrinterDebugPage(), formatTimeWIB() (+16 more)
...
Cohesion: 0.18
Nodes (7): HomeTodayRpc, accentClasses, HomeTiles(), tiles, Agent, DisplayState, PrinterStatusBanner()
...
Cohesion: 0.11
Nodes (24): CATEGORY_LABEL, Menu, MenuChip, MenuListClient(), ChipOption, ChipPicker(), MenuForm(), MenuFormValues (+16 more)

### Community 18 - "POS API & Chips Helpers"
Cohesion: 0.08
Nodes (36): POST(), CreatePosTransaction, CreatePosTransactionSchema, applyHeaderUpdate(), GET(), PATCH(), PatchSchema, replaceItems() (+28 more)
...
Cohesion: 0.13
Nodes (16): NotaItem, NotaItemRow(), Tier, TIER_CLASS, tierOf(), ItemForQueue, ModalContext, Transaction (+8 more)

### Community 23 - "Menu & Printer Forms"
Cohesion: 0.20
Nodes (14): initialState, initialState, MenuTotal, Mismatch, categoryOptions, ChipDraft, Button(), buttonVariants (+6 more)
...
Cohesion: 0.11
Nodes (18): AppLayout(), MobileNav(), NavLink, links, Nav(), SetupMenu(), DropdownMenu(), DropdownMenuCheckboxItem() (+10 more)
...
Cohesion: 0.50
Nodes (4): loginAction(), LoginSchema, LoginState, LoginPage()
...
## Knowledge Gaps
- **311 isolated node(s):** `MenuChip`, `Menu`, `CATEGORY_LABEL`, `HomeTodayRpc`, `DailyRpc` (+306 more)
...
- **Why does `cn()` connect `Reports UI + shadcn Cards` to `App Layout & Nav`, `Monthly Chart & Chart Primitives`, `Monitor & Detail Views`, `Menu List & Dialog UI`, `Menu & Printer Forms`?**
