...
- **Runaway guardrails (2026-07-11, defense-in-depth 2026-07-12)**: 3 layer, urut dari preemptive → salvage:
  ...
  2. **`stopSequences`** di `lib/gemini.ts`: `['8888888', '9999999', ..., '7777777']` (10 sequences run-of-7 digit). Model auto-stop begitu detect → `finishReason='STOP'` di ~50 tok bukan 700. Real content ga akan trigger (rupiah 6 digit max, nomor meja ≤3 char).
