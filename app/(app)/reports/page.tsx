...
export default async function ReportsPage() {
  const actor = await requireAnyPermission(['reports.daily.view', 'reports.monthly.view']);
  const showDaily = can(actor, 'reports.daily.view');
  const showMonthly = can(actor, 'reports.monthly.view');
